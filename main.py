...
class RRT():
    ...
    def DrawGraph(self, rnd=None):
        ...
        plt.axis([38130.277, 38161.888, -76411.205, -76443.536])
        plt.grid(True)
        plt.pause(0.000001)
...
def main():
    ...
    # Parameter
    obstacleList = [
        (38140.578, -76428.997, 1),
        (38149.156, -76430.622, 1),
    ...
    rrt = RRT(start=[38145.333, -76428.333], goal=[38159.777, -76440.000],
              randArea=[68145, -176428], obstacleList=obstacleList)
    ...
    with open('/home/clarkaerospace/Documents/coords.txt', 'w') as f:   #change file path ///////////////////////////////////////
